...
fn mapKeycode(key: sapp.Keycode) zgui.Key {
    switch (key) {
        ...
        sapp.Keycode._0 => return zgui.Key.zero,
        sapp.Keycode._1 => return zgui.Key.one,
        sapp.Keycode._2 => return zgui.Key.two,
        sapp.Keycode._3 => return zgui.Key.three,
        sapp.Keycode._4 => return zgui.Key.four,
        sapp.Keycode._5 => return zgui.Key.five,
        sapp.Keycode._6 => return zgui.Key.six,
        sapp.Keycode._7 => return zgui.Key.severn,
        sapp.Keycode._8 => return zgui.Key.eight,
        sapp.Keycode._9 => return zgui.Key.nine,
